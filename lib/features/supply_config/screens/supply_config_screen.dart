...
class SupplyConfigScreen extends StatelessWidget {
  const SupplyConfigScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.settings_suggest_rounded, size: 64, color: AppColors.textSecondary.withValues(alpha: 0.4)),
